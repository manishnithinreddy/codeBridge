...
// import org.springframework.transaction.annotation.Propagation; // No longer needed for createLog's direct DB write
import org.springframework.transaction.annotation.Transactional; // Still needed for read methods

// import java.time.LocalDateTime; // No longer needed for manual timestamp in createLog
...
public class ServerActivityLogService {
    ...
    public void createLog(UUID platformUserId, String action, UUID serverId, String details, String status, String errorMessage) {
        try {
            ...
            logger.info("Activity log event published: User: {}, Action: {}, ServerID: {}", platformUserId, action, serverId);

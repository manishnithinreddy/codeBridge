...
public class SshSessionMetadata implements Serializable {
    ...
    private String applicationInstanceId; // Identifier for the app instance holding the live JSch session
    ...
    public String toString() {
        return "SshSessionMetadata{" +
               ...
               ", jwtToken='" + (jwtToken != null ? "[PRESENT]" : "[NULL]") + '\'' + // Avoid logging full token

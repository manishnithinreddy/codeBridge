...
public class RemoteFileEntry {
    ...
    private long size;
    private String lastModified; // e.g., "Tue Nov 28 10:37:17 UTC 2023" from LsEntry.getAttrs().getMtimeString()
    private String permissions;  // e.g., "drwxr-xr-x" from LsEntry.getAttrs().getPermissionsString()

...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAuthenticationException(AuthenticationException ex, WebRequest request) {
        ...
        // logger.warn("Authentication failure: {}", ex.getMessage()); // Add logger if not present
        return new ResponseEntity<>(errorResponse, HttpStatus.UNAUTHORIZED);
    }

    @ExceptionHandler(SpringSecurityAccessDeniedException.class)
    public ResponseEntity<ErrorResponse> handleSpringSecurityAccessDeniedException(SpringSecurityAccessDeniedException ex, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
        ...
        // logger.warn("Spring Security Access Denied: {}", ex.getMessage()); // Add logger if not present
